    ...
    <div className="column">
      <div className="card mb-5">
        <div className="card-content">
          ...
          <div className="buttons is-centered">
            ...
            <a
              href="https://www.youtube.com/channel/UCrWJWPKeVUsjYXPPJJ42jUw"
              className="button is-large is-warning"
            >
              YouTube
            </a>
            <a
              href="https://www.facebook.com/matthewxgoad"
              className="button is-large is-warning"
            >
              Facebook
            </a>
            <a href={resume} className="button is-large is-warning">
              Download Resume
            </a>
          </div>
        </div>
      ...
      <div className="card">
        <div className="card-content has-text-centered">
          <h1 className="title">
            <em>"In this life there are nothing but possibilities."</em>
          </h1>
